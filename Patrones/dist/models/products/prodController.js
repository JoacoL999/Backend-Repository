...
const prodAPI_1 = __importDefault(require("./prodAPI"));
const error_1 = require("../../services/error");
let productosDao;
prodAPI_1.default.getInstance().then((instance) => {
...
const exists = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new error_1.ApiError('Objeto no encontrado', error_1.ErrorStatus.NotFound);
    }
    next();
});
