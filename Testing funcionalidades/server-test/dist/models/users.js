...
exports.UsersModel = exports.dbCollection = void 0;
...
exports.UsersModel = mongoose_1.default.model(exports.dbCollection, userSchema);
class Users {
    constructor() {
    ...
    userDisconnect() {
        return __awaiter(this, void 0, void 0, function* () {
            yield mongoConnection_1.default.connection.close();
        });
    }
    getUser() {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateUser(id, user) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.users.findByIdAndUpdate(id, user, { new: true });
                return response;
            }
            catch (error) {
                loggers_1.errorLogger.error(error.message);
    ...
    deleteUser(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.users.findByIdAndDelete(id);
                return response;
            }
            catch (error) {
                loggers_1.errorLogger.error(error.message);
