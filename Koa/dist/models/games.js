...
exports.gameGraphQlModel = exports.gamesCollectionName = void 0;
...
const schemaTest = mongoose_1.default.model(exports.gamesCollectionName, gameSchema);
class Games {
    constructor() {
...
exports.gameGraphQlModel = (0, graphql_compose_mongoose_1.composeWithMongoose)(schemaTest);
